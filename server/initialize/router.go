...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		autocodeRouter.InitErpListingDetailRouter(PrivateGroup)
		autocodeRouter.InitSpConfigRouter(PrivateGroup)
